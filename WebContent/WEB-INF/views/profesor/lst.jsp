									...
									<tbody>
										<c:forEach items="${lstProfesores}" var="profesor">
											<tr>
												...
												<td>
													<a href="./edit/${profesor.id}" title="Editar"> 
														<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
													</a> 
													<a href="#" data-href="<c:url value='delete/${profesor.id}'/>" data-toggle="modal" data-target="#confirm-delete"
													title="eliminar"> 
