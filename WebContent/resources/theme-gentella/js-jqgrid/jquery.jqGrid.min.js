...
*
* Modules: grid.base.js; jquery.fmatter.js; grid.common.js; grid.formedit.js; grid.filter.js; grid.inlinedit.js; grid.celledit.js; jqModal.js; jqDnR.js; grid.utils.js;
*/
...
h=document.createElement("a");h.href=e,h.download=b,document.body.appendChild(h),h.click(),setTimeout(function(){document.body.removeChild(h),window.URL.revokeObjectURL(e)},0)}},window.jqGridUtils});